...
var skipMouseDown = 'input,textarea,button,select,option, [contenteditable="true"]>*:not([contenteditable="false"]),.ui-resizable-handle';
// let count = 0; // TEST
var DDDraggable = exports.DDDraggable = /** @class */ (function (_super) {
    ...
    function DDDraggable(el, option) {
        ...
        _this.dragEls = el.matches(option.handle) ? [el] : ((n === null || n === void 0 ? void 0 : n.subGrid) ? [el.querySelector(option.handle) || el] : Array.from(el.querySelectorAll(option.handle)));
    ...
    DDDraggable.prototype._mouseDown = function (e) {
        ...
        while (element && !element.matches(this.option.handle)) {
